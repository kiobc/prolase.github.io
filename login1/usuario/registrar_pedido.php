 <?php
    ...
    $sql = "SELECT COUNT(*) total FROM usuario_pedidos where id_usuario='$nombre' and   EstadoEntrega_pedido='Pendiente'";
         ...
         <nav id="sidebar" class="">
             ...
             <div class="nalika-profile">
                 <div class="profile-dtl">
                     ...
                     <h2>Usuario@ <span class="min-dtn">Prolase</span></h2>
                 </div>
                                             ...
                                             <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                 ...
                                                 <li class="nav-item">
                                                     ...
                                                     <a href="#">
                                                         ...
                                                         <i></i>
                                                         <span><a href="../../login1/usuario/pedido_mostrar.php"><img src="../../images/carrito.png" style="width: 50px"><?php echo "Producto añadido:" . $fila['total']; ?></a> </span>
                                                     ...
                                                     <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                         ...
                                                         <li><a href="informacion.php"><span class="icon nalika-user author-log-ic"></span> Mi perfil</a>
                                                         </li>
                                     ...
                                     <ul class="mobile-menu-nav">
                                         ...
                                         <li><a data-toggle="collapse" data-target="#demo" href="#">Mailbox <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                             <ul id="demo" class="collapse dropdown-header-top">
                                                 ...
                                                 <li><a href="mensaje_mostrar.php">View Mail</a>
                                                 </li>
                                     ...
                                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                         <div class="breadcomb-wp">
                                             ...
                                             <div class="breadcomb-ctn">
                                                 ...
                                                 <p>Bienvenid@ <span class="bread-ntd"><?php echo '' . $nombre ?> </span></p>
                                             </div>
                                         </div>
                                     </div>
                             ...
                             <table class="table table-bordered">
                                 <thead>
                                     <tr>
                                         ...
                                         <th class="p-3 mb-2 bg-primary text-white" scope="col">Acción</th class="p-3 mb-2 bg-primary text-white">
                                     </tr>
                                 </thead>
                                 <tbody>
                                     <tr>
                                         <th scope="row">1</th>
                                         <td><br><img src="../../images/queso012.jpg" style="width:300px" style="height: 250px"></td>
                                         <td style="width: auto;"><br><br><br><br><strong>Descripción del producto:</strong>
                                             ...
                                             <p>Un color blanco con tonos amarillentos y una corteza blanda,</p>
                                             </p>
                                         ...
                                         <td>
                                             <form action="../../login1/procesos/guardar_pedido.php" method="POST">
                                                 ...
                                                 <input class="form-control" id="exampleFormControlInput1" value="<?php echo '' . $nombre;  ?>" type="hidden" name="id_usuario" required>
                                                 <br>
                                                 ...
                                                 <input class="form-control" id="exampleFormControlInput1" type="number" name="cantidad_pedido" required>
                                                 ...
                                                 <input class="form-control" id="exampleFormControlInput1" type="hidden" name="fechaEntrega_pedido" required>
                                         ...
                                         <td> <input type="submit" class="btn btn-primary" value="Agregar" onclick="return confirmar()"> </td>
                                         </form>
                                         <script>
                                             function confirmar() {
                                                 if (confirm("Seguro que quiere confirmar el pedido ")) {
                                                     return true;
                                     ...
                                     <tr>
                                         <th scope="row">2</th>
                                         <td><br><img src="../../images/queso1.jpg" style="width:300px" style="height: 250px"></td>
                                         <td style="width: auto;"><br><br><br><br><strong>Descripción del producto:</strong>
                                             <p>Queso es el producto fresco o maduro, sólido o semisólido,</p> que resulta de la coagulación de la leche natural.<p> <strong>Tipo de queso:</strong> </p>
                                             <p>Un color blanco con tonos amarillentos y una corteza blanda,</p>
                                             </p>
                                         ...
                                         <td>
                                             <form action="../../login1/procesos/guardar_pedido.php" method="POST">
                                                 ...
                                                 <input class="form-control" id="exampleFormControlInput1" type="date" name="fechaRealizacion_pedido">
                                                 <input class="form-control" id="exampleFormControlInput1" type="hidden" value="0" name="fechaEntrega_pedido">
                                                 <label> <strong>Estado del producto</strong></label>
                                                 <select class="form-control" id="exampleFormControlInput1" name="EstadoEntrega_pedido">
                                                     <option>Pendiente</option>
                                                 </select>
