...
<head>
    ...
    <title>Mostrar pedidos pendientes</title>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="../../login1/usuario/registrar_pedido.php">Añadir producto</a>
                            </div>

                            <a class="btn btn-primary" href="pedido_resultado.php">Descargar pedido</a>
                            <table class="table">
                                <tr>
                                    <td> Id del pedido </td>
                                ...
                                <?php
                                $query_rs_producto = "select * from usuario_pedidos where id_usuario ='$nombre' and     EstadoEntrega_pedido='Pendiente'";
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $row_rs_producto['id_pedidos']; ?></td>
                                        <td><?php echo $row_rs_producto['id_usuario']; ?></td>
                                        <td><?php echo $row_rs_producto['tipoProducto_pedido']; ?></td>
                                        <td><?php echo $row_rs_producto['cantidad_pedido']; ?></td>
                                        <td><?php echo $row_rs_producto['fechaRealizacion_pedido']; ?></td>

                                        <td><?php echo $row_rs_producto['EstadoEntrega_pedido']; ?></td>

                                        <td>


                                            <a onclick="javascript:return asegurar();" href=" ../../login1/usuario/eliminar1.php?id=<?php echo ($row_rs_producto['id_pedidos']); ?>"><input type="button" name="" value="Eliminar">
                                            </a>
                                        </td>
