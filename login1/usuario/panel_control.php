                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											<div class="breadcomb-icon">
												<br>   <br>   <br><i class="icon nalika-home"></i>
                                            </div>
                                         
											   <div class="breadcomb-ctn">
												<br>   <br>   <br><h2>Panel de administración</h2>
												<p>Bienvenido   <span class="bread-ntd"></span></p>
											</div>
										</div>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="author-widgets-single res-mg-t-30">
                            ...
                            <div class="widget-text-box">
                               ...
                               <center> <p>Bienvenido al panel de administración del usuario</p></center>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="breadcomb-wp">
                                                        ...
                                                        <div class="breadcomb-ctn">
                                                            ...
                                                            <p>Los mejores gestiónando tu información <span class="bread-ntd">Panel de administración</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
