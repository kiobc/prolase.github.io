...
<head>
    ...
    <title>Mostrar productos despachados</title>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="../../login1/usuario/registar_pedido.php">Añadir producto</a>
                            </div>
                            ...
                            <table class="table">
                                ...
                                <?php
                                $query_rs_producto = "select * from usuario_pedidos where id_usuario ='$nombre' and     EstadoEntrega_pedido='Despachado'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row_rs_producto['fechaEntrega_pedido']; ?></td>
