                         ...
                         <form action="modificar_producto.php" method="POST" enctype="multipart/form-data">
                            <div class="container-fluid">
                                <div class="col-auto">
                                    ...
                                    $re = mysql_query("select id_catalogo,nombre_producto,tipo_producto,descripcion_producto,imagen_producto  from catalogo_producto where id_catalogo = " . $_GET['editar'] . ";");
                                    while ($f = mysql_fetch_array($re)) {
                                    ?>
                                        <input type="hidden" id="id" name="id_catalogo" value="<?php echo $f['id_catalogo']; ?>" />

                                        <input name="nombre_producto" type="text" id="username" required pattern="[A-Za-z0-9]+" required class="form-control mb-2" id="inlineFormInput" value="<?php echo $f['nombre_producto']; ?>" placeholder=" Ingrese el nombre del producto">
                                        <input required name="tipo_producto" type="text" class="form-control mb-2" id="inlineFormInput" value="<?php echo $f['tipo_producto']; ?>" placeholder=" Ingrese el tipo de producto">
                                        <input required name="descripcion_producto" type="text" class="form-control mb-2" id="inlineFormInput" value="<?php echo $f['descripcion_producto']; ?>" placeholder=" Ingrese la descripcion del producto">
                                        <center> <span class="min-dtn" style="color:#FFFFFF;">Foto en publicación"</span><br>
                                            <?php echo "<img id='actual' class=\"imagen\" src=\"" . "crud_catalogo/Imagenes/" . $f['imagen_producto'] . "\"/>"; ?>
                                            <input required value="<?php echo $f['imagen_producto']; ?>" type="file" name="foto" id="imgInp"><br><br>
                                        <?php } ?>
                                        </center>
                                        <center>
                                            <labe> </label>
                                                <span class="min-dtn" style="color:#FFFFFF;">Foto en ha publicar / realizar el cambio"</span><br>
                                                <img id="blah" src="https://fakeimg.pl/350x200/ffffff/000" alt="Tu imagen" />
                                        </center><br><br>
                                        <center>
                                            <input class="btn btn-primary" type="submit" value="Modificar">
                                            <a href="producto_mostrar.php" class="btn btn-primary">Regresar</a>
                                        </center>
                                        </form>
                                        <hr>
                                        <style type="text/css">
