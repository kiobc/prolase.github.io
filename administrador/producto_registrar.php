        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap">
                    <center>
                        <h4>Registrar producto al catalogo
                        </h4>
                    </center>
                    ...
                    <ul class="list-group">
                        <li class="product-status-wrap">
                            <form action="crud_catalogo/Acciones/guardar.php" method="POST" enctype="multipart/form-data">
                                <div class="container-fluid">
                                    <div class="col-auto">
                                        <input type="hidden" name="id_catalogo" value="0">
                                        <label class="sr-only" for="inlineFormInput">Nombre</label>
                                        <input name="nombre_producto" type="text" class="form-control mb-2" id="d1" placeholder="&#129371;Ingrese el nombre del producto">
                                        <input name="descripcion_producto" type="text" class="form-control mb-2" id="d2" placeholder="&#129472;Ingrese el tipo de producto">
                                        <input name="tipo_producto" type="text" class="form-control mb-2" id="d3" placeholder="&#128456;Ingrese la descripcion del producto">
                                        <input type="file" name="imagen_producto" id="imgInp">
                                        <center> <img id="blah" src="https://fakeimg.pl/350x200/ffffff/000" alt="Tu imagen" /><br><br>
                                            <input type="submit" class="btn btn-primary" value="Guardar">
                                            <a href="producto_registrar.php" onclick="alert(' No se ha añadir  del producto al catalogo ');" class="btn btn-primary"> Cancelar</a>
                                        </center>
                                        <hr>
