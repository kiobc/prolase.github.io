                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="product-status-wrap">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <?php
                                                            $query_rs_producto = "select * from  usuario ";
                                                            ...
                                                            ?> <tr>
                                                                    ...
                                                                    <td><?php echo $row_rs_producto['user']; ?></td>
                                                                    <td><?php echo $row_rs_producto['password1']; ?></td>
                                                                    <td><?php echo $row_rs_producto['email']; ?></td>
                                                                    <td>
                                                                        <button data-toggle="tooltip" title="Editar aspirante" class="pd-setting-ed"><a href="usuario_editar.php?id=<?php echo ($row_rs_producto['id_usuario']); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Editar</button>
