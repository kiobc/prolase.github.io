...
require 'cn.php';
 ...
 $div1='</div> ';
	...
	$sql = "SELECT * FROM usuario_pedidos $where";
...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <center>  <h4>Lista de pedidos modificar</h4><center> 
  ...
  <div class="container-fluid">
    <div class="col-auto">
      ...
      <input required name="campo" type="text" class="form-control mb-2" id="inlineFormInput" placeholder="Ingrese palabra clave">  
...
<a href="panel_control.php" class="btn btn-primary mb-2">Cancelar</a>
 
<?php if($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
				
    <div class="product-status-wrap">			   
                <?php echo"<center>"; echo'<p class="p-3 mb-2 bg-white text-dark">'; echo "Has buscado  la clave:";echo'<strong>'.$valor; echo'</strong></p>
                   <p class="p-3 mb-2 bg-white text-dark"><strong>';echo 'Pedido  encontrado'; echo'</strong></p>';  echo"</center>"; ?>
           </div>
           <?php }else{

echo"<center>"; echo '<p class="p-3 mb-2 bg-white text-dark">Has buscado  la clave: ';echo'<strong>'.$valor; echo'</strong></p>
                   <p class="p-3 mb-2 bg-white text-dark"><strong>';echo 'Pedido no encontrado'; echo'</strong></p></div>';echo"<center>";
           }?>
    </div>
						...
						<?php 
						 while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><?php echo $row['tipoProducto_pedido']; ?></td>
								<td><?php echo $row['cantidad_pedido']; ?></td>
								<td><?php echo $row['fechaRealizacion_pedido']; ?></td>
								<td><?php echo $row['fechaEntrega_pedido']; ?></td>
								<td><?php echo $row['EstadoEntrega_pedido']; ?></td>
								<td><a href="editar_pedidoD.php?id=<?php echo $row['id_pedidos']; ?>"><span class="glyphicon glyphicon-pencil"></span>Modificar</a></td>
                <td>&nbsp&nbsp&nbsp&nbsp&nbsp <a   href="panel_control.php" > <span class="glyphicon glyphicon-remove"  ></span>Cancelar</a></td>
							</tr>
						<?php } ?>
...
</ul> <div class="product-status mg-b-30">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
