                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <?php if ($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
                                                    ...
                                                    <div class="product-status-wrap">
                                                        <?php echo "<center>";
                                                        echo '<p class="p-3 mb-2 bg-white text-dark">';
                                                        echo "Has buscado  la clave:";
                                                        echo '<strong>' . $valor;
                                                        echo '</strong></p>
                   <p class="p-3 mb-2 bg-white text-dark"><strong>';
                                                ...
                                                <?php } else {
                                                    ...
                                                    echo "<center>";
                                                    echo '<p class="p-3 mb-2 bg-white text-dark">Has buscado  la clave: ';
                                                    echo '<strong>' . $valor;
                                                    echo '</strong></p>
                   <p class="p-3 mb-2 bg-white text-dark"><strong>';
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        while ($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
                                                                            <tr>
                                                                                ...
                                                                                <td><a href="eliminar1.php?id=<?php echo $row['id_pedidos']; ?>" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span>Eliminar</a></td>
                                                                                <td>&nbsp&nbsp&nbsp&nbsp&nbsp <a onclick="alert('Pedido no eliminado');" href="panel_control.php"> <span class="glyphicon glyphicon-remove"></span>Cancelar</a></td>
                                                                            </tr>
                                                                        <?php } ?>
