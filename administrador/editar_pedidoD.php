...
<head>
    ...
    <title>Editar pedidos depachados</title>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Editar pedido</a></li>
                                </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    $query_rs_producto = sprintf("Select * from  usuario_pedidos where id_pedidos='%s'", $_GET['id']);
                                                    ...
                                                    <form action="editar.php" method="Post">
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <input required type="text" value="<?php echo ($row_rs_producto['id_usuario']); ?>" class="form-control" name="id_usuario" placeholder="Nombre del mensaje: ejemplo@yahoo.com">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input required type="text" value="<?php echo ($row_rs_producto['tipoProducto_pedido']); ?>" class="form-control" name="tipoProducto_pedido" placeholder="Asunto del mensaje">
                                                        </div>

                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input required type="number" value="<?php echo ($row_rs_producto['cantidad_pedido']); ?>" class="form-control" name="cantidad_pedido" placeholder="Asunto del mensaje">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <input required type="date" value="<?php echo ($row_rs_producto['fechaRealizacion_pedido']); ?>" class="form-control" name="fechaRealizacion_pedido" placeholder=" Fecha de peticion">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <input required type="date" value="<?php echo ($row_rs_producto['fechaEntrega_pedido']); ?>" class="form-control" name="fechaEntrega_pedido" placeholder=" Fecha de peticion">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <input required type="text" value="<?php echo ($row_rs_producto['EstadoEntrega_pedido']); ?>" class="form-control" placeholder=" Fecha de peticion">
                                                            <select class="form-control" name="EstadoEntrega_pedido">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <input type="text" value="<?php echo ($row_rs_producto['id_pedidos']); ?>" class="form-control" name="id_pedidos" placeholder=" Fecha de peticion">


                                                        </div>

                                                        <div class="input-group mg-b-pro-edt">
                                                            <input type="hidden" class="form-control" value="<?php echo ($row_rs_producto['id_pedidos']); ?>" 0 name="id_mensaje" placeholder=" id">
                                                        </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <button type="submit" class="btn btn-ctl-bt waves-effect waves-light m-r-10">Guardar
                                                    </button>
                                                    <a onclick="alert('Usted a cancelado  la acción de editar');" href="panel_control.php" class="btn btn-ctl-bt waves-effect waves-light">Cancelar</a>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
