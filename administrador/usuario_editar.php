                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="aspirante_mostrar.php"><span class="mini-sub-pro">Consultar aspirante</span></a></li>
                            ...
                            <div class="review-tab-pro-inner">
                                <center>
                                    <ul id="myTab3" class="tab-review-design">
                                        < <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Edite los campos por favor </a></li>
                                            <center>
                                                <h2> </h2>
                                            </center>
                                    </ul>
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <form action="editar_usuario.php" method="Post" onclick="return validar()">
                                        <div class="product-tab-list tab-pane fade active in" id="description">
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="review-content-section">
                                                        <?php
                                                        $query_rs_producto = sprintf("Select * from  usuario where id_usuario='%s'", $_GET['id']);
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <input type="text" value="<?php echo ($row_rs_producto['user']); ?>" class="form-control" name="user" placeholder="Nombre del usuario">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input required type="text" value="<?php echo ($row_rs_producto['password1']); ?>" class="form-control" name="password1" id="miCampo2" placeholder="Apellido del usuario" required>
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input required type="email" value="<?php echo ($row_rs_producto['email']); ?>" class="form-control" name="email" id="email" id="miCampo3" placeholder="Email del usuario" required>
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <input required type="hidden" class="form-control" value="<?php echo ($row_rs_producto['id_usuario']); ?>" name="id_usuario" id="miCampo4" placeholder=" id" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="text-center custom-pro-edt-ds">
                                                        <input type="submit" onclick="javascript:return asegurar();" class="btn btn-ctl-bt waves-effect waves-light m-r-10" value="Guardar">

                                                        <button href="panel_control.php" onclick="alert('Usted ha cancelado la acción de editar');" class="btn btn-ctl-bt waves-effect waves-light">Cancelar
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <script>
                                        function asegurar() {
                                            rc = confirm("¿Seguro que desea editar al usuario?");
                                            return rc;
                                        }
                                    </script>
                                    <script type="text/javascript">
                                        function validar() {
                                            ...
                                            miCampoTexto1 = document.getElementById("miCampo1").value;
                                            miCampoTexto2 = document.getElementById("miCampo2").value;
                                            miCampoTexto3 = document.getElementById("miCampo3").value;

                                            //la condición
                                            if (miCampoTexto1 == "" || miCampoTexto2 == "" || miCampoTexto3 == "" || miCampoTexto4.length == "") {
