...
if (!empty($_POST)) {
    ...
    if (!empty($valor6)) {
        $where4 = "WHERE id_aspirante LIKE '%$valor6'  ";
    }
}
$sql = "SELECT * FROM postulacion_aspirante $where4";
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="usuario_buscar.php"><span class="mini-sub-pro">Buscar catalogo</span></a></li>
                                <li><a title="Dashboard v.1" href="usuario_buscar.php"><span class="mini-sub-pro">Registar catalogo</span></a></li>
                                <li><a title="Dashboard v.2" href="usuario_mostrar.php"><span class="mini-sub-pro">Editar y eliminar</span></a></li>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while ($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $row['aniosExperiencia_postulacion']; ?></td>
                                                                        <td><?php echo $row['cargo_postulacion']; ?></td>
                                                                        <td><?php echo $row['lugar_postulacion']; ?></td>
                                                                        <td><?php echo $row['area_conocimiento']; ?></td>
                                                                        <td><?php echo $row['estado_postulacion']; ?></td>
                                                                        <td><a href="postulante.php?id=<?php echo $row['id_postulacion']; ?>"><span class="glyphicon glyphicon-pencil"></span>Modificar</a></td>
