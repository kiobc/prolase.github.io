                                                    ...
                                                    <div class="product-status-wrap">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $re = mysql_query("select * from catalogo_producto") or die(mysql_error());
                                                                while ($f = mysql_fetch_array($re)) {
                                                                ?>
                                                                    <tr>
                                                                        <td><?php echo $f['id_catalogo']; ?></td>
                                                                        <td><?php echo $f['nombre_producto']; ?></td>
                                                                        <td><?php echo $f['tipo_producto']; ?></td>
                                                                        <td><?php echo $f['descripcion_producto']; ?></td>
                                                                        <td><?php echo "<img class=\"imagen\" src=\"" . "crud_catalogo/Imagenes/" . $f['imagen_producto'] . "\"/>"; ?></td>
                                                                        <td><?php echo '<a href="producto_extraer.php?editar=' . $f['id_catalogo'] . '"><span class="glyphicon glyphicon-pencil"></span>Modificar</a>'; ?>
                                                                        <td>
                                                                            <?php echo '<a onclick="return confirmar()" href="eliminar_producto.php?eliminar=' . $f['id_catalogo'] . '"><span class="glyphicon glyphicon-pencil"></span>Eliminar</a>'; ?> </td>
                                                                    </tr>
                                                                <?php
                                                                }
                                                                ?>
