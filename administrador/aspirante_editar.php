                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Editar aspirante</a></li>
                                </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    ?>
                                                    <form action="../aspirante/actualizar.php" method="Post">
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                            <input type="text" value="<?php echo ($row_rs_producto['nombre_aspirante']); ?>" class="form-control" name="nombre_aspirante" placeholder="Nombre del aspirante">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input type="textarea" value="<?php echo ($row_rs_producto['apellido_aspi']); ?>" class="form-control" name="apellido_aspi" placeholder="Apellido del aspirante">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input type="textarea" value="<?php echo ($row_rs_producto['anios_aspi']); ?>" class="form-control" name="anios_aspi" placeholder="Años del aspirante">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input type="textarea" value="<?php echo ($row_rs_producto['email_aspi']); ?>" class="form-control" name="email_aspi" placeholder="Email del aspirante">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input type="textarea" value="<?php echo ($row_rs_producto['cargo_postulacion']); ?>" class="form-control" name="cargo_postulacion" placeholder="Cargo de postulacion">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input type="textarea" value="<?php echo ($row_rs_producto['lugar_postulacion']); ?>" class="form-control" name="lugar_postulacion" placeholder="Lugar de postulacion">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input type="textarea" value="<?php echo ($row_rs_producto['aniosExperiencia_postulacion']); ?>" class="form-control" name="aniosExperiencia_postulacion" placeholder="Años de experiencia">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input type="textarea" value="<?php echo ($row_rs_producto['area_conocimiento']); ?>" class="form-control" name="area_conocimiento" placeholder="Area de conocimiento">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <input type="hidden" class="form-control" value="<?php echo ($row_rs_producto['id_postulacion']); ?>" 0 name="id_postulacion" placeholder=" id">
                                                        </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <button type="submit" class="btn btn-ctl-bt waves-effect waves-light m-r-10">Editar Aspirante
                                                    </button>
                                                    <button type="button" class="btn btn-ctl-bt waves-effect waves-light">Cancelar
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
