        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="panel_control.php">Panel Control <span class="sr-only">(current)</span></a>
            </li>  
...
<div class="container">
 <h4 class="mt-5">Buscar Aspirante</h4>
 <hr>
...
<form method="post">
  <div class="form-row align-items-center">
    ...
    <div class="col-auto">
      <button type="submit" onclick="alert('Consultando')"; class="btn btn-primary mb-2">Consultar</button>
      <a class="btn btn-primary mb-2"onclick="alert('Consulta cancelada')"; href="panel_control.php" >Cancelar</a>
    </div>
  </div>
</form>
  </li>
...
if(!empty($_POST))
{
      ...
      $query ="SELECT * FROM aspirante WHERE id_aspirante like '%" . $aKeyword[0] . "%' OR apellido_aspi like '%" . $aKeyword[0] . "%'";
     ...
     echo "<tr><td>".$cedula." </td><td>". $nombre . "</td><td>". $apellido. "</td><td>". $ciudad."</td><td>".$email ."</td><td>". $telefono."</td></tr>";     
     if(mysqli_num_rows($result) > 0) {
        $row_count=0;

        echo "<br><br>Aspirante Encontrado ";
    
       
        While($row = $result->fetch_assoc()) {   
            $row_count++;                         
            echo "<tr><td>".$row['id_aspirante']." </td><td>". $row['nombre_aspi'] . "</td><td>". $row['apellido_aspi'] . "</td><td>". $row['ciudad']."</td><td>". $row['email_aspi']."</td><td>". $row['telefono_aspi']."</td></tr>";
        }
        echo "</table>";
