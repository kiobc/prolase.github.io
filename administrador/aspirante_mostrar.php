...
<?php
	...
	if(!empty($_POST))
	{
		$valor1 = $_POST['campo'];
		if(!empty($valor)){
			$where2 = "WHERE id_aspirante LIKE '%$valor1'";
		}
	}
	$sql = "SELECT * FROM aspirante  $where2";
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                           <center> <h4>Lista de aspirantes</h4></center>
...
<a href="panel_control.html" onclick="alert('Consulta cancelada');" class="btn btn-primary mb-2">Cancelar</a>
 </center>
 
<?php if($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
				
    <div class="product-status-wrap">			   
                <?php echo"<center>"; echo'<p class="p-3 mb-2 bg-white text-dark">'; echo "Has buscado  la clave:";echo'<strong>'.$valor1; echo'</strong></p>
                   <p class="p-3 mb-2 bg-white text-dark"><strong>';echo 'Aspirante encontrado'; echo'</strong><br> Consultando</p>';  echo"</center>"; ?>
           </div>
           <?php }else{

echo"<center>"; echo '<p class="p-3 mb-2 bg-white text-dark">Has buscado  la clave: ';echo'<strong>'.$valor1; echo'</strong></p>
                   <p class="p-3 mb-2 bg-white text-dark"><strong>';echo 'Aspirante no encontrado'; echo'</strong></p></div>';echo"<center>";
           }?>
    </div>
					...
					<tbody>
						<?php 
						 while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
                            <td><?php echo $row['nombre_aspi']; ?></td>
                            <td><?php echo $row['apellido_aspi']; ?></td>
                            <td><?php echo $row['ciudad']; ?></td>
                            <td><?php echo $row['email_aspi']; ?></td>
                            <td><?php echo $row['telefono_aspi']; ?></td>
                            <td><?php echo $row['password1']; ?></td>
                            <td><a href="<?php echo $row['hoja']; ?>">  Hoja de vida </a></td>
