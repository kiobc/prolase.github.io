...
if (!empty($_POST)) {
    ...
    if (!empty($valor)) {
        $where = "WHERE id_usuario LIKE '%$valor' and  EstadoEntrega_pedido='Pendiente'";
    }
}
                                    ...
                                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                        <div class="container-fluid">
                                            <div class="col-auto">
                                                ...
                                                <input required name="campo" type="text" class="form-control mb-2" id="inlineFormInput" placeholder="Cedula del usuario">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <a href="panel_control.html" class="btn btn-primary mb-2">Cancelar</a>
